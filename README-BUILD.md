# Kliptora v2.3.2 — Windows installer build
...
```text
release\Kliptora-Setup-v2.3.2.exe
```

## GitHub Actions

Actions > Build clean Windows installer > Run workflow.
İş tamamlandıktan sonra Artifacts bölümünden `Kliptora-v2.3.2-Windows` indirilir.
